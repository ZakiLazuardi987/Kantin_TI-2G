      ...
      <div class="row">
        <div class="card mx-auto" style="width: 400px; height: auto;">
          <ul class="list-group list-group-flush">
            <?php if (!empty($data['detail'])) { // Check if the array is not empty before looping ?>
              <!-- Move the following sections outside the loop -->
              <li class="list-group-item d-flex justify-content-between lh-sm" style="background: #F6E8C1;">
                <div>
                  ...
                  <small class="text-body-secondary">Id: <?= $data['detail'][0]['id_transaksi']?></small>
                </div>
                <span class="text-body-secondary"><h6><?= $data['detail'][0]['tgl_order']?></h6></span>
              </li>
