      ...
      <!-- <div class="modal-body"> -->
        ...
        <div class="card mx-auto" style="width: 400px; height: auto;">
          <ul class="list-group list-group-flush">
            ...
            <span class="text-body-secondary"><h6><?php $data['detail']['tanggal']; ?></h6></span>
            </li>
            ...
            <li class="list-group-item d-flex justify-content-between lh-sm">
              ...
              <!-- Line 36 -->
              <span class="text-body-secondary mb-2"><h6 align="right"><?= isset($data['detail']['id_transaksi']) ? $data['detail']['id_transaksi'] : 'N/A' ?></h6></span>
              <!-- Line 37 -->
              <span class="text-body-secondary mb-2"><h6 align="right"><?= isset($data['transactionDetails']['total_qty']) ? $data['transactionDetails']['total_qty'] : 'N/A' ?></h6></span>
              <!-- Line 38 -->
              <span class="text-body-secondary"><h6 align="right"><?= isset($data['transactionDetails']['total_bayar']) ? 'Rp. ' . number_format($data['transactionDetails']['total_bayar'], 0, ',', '.') : 'N/A' ?></h6></span>

              <!-- Add the provided code block after the existing code -->

            <?php
            // Check if the key "transaksi" exists in the $data array
            if (isset($data['transactionDetails']) && is_array($data['transactionDetails'])) {
                $transaksi = $data['transactionDetails'];
